...
export default function ImpactHistoryScreen({ navigation, route }) {
  ...
  // ✅ State สำหรับเปิด/ปิด หน้าต่างอธิบายสูตรการคำนวณ
      ...
      <View style={styles.summarySection}>
        <View style={styles.summaryTitleRow}>
            <Text style={styles.summaryTitle}>
              {isFood ? "ปริมาณขยะอาหารที่คุณช่วยลดได้" : "ปริมาณก๊าซคาร์บอนที่คุณช่วยลดได้"}
            </Text>
            {/* ✅ ปุ่ม Info (i) เพื่อกดดูที่มาของตัวเลข */}
          ...
          <View style={styles.modalOverlay}>
              <View style={styles.modalBox}>
                  <View style={styles.modalIconCircle}>
                      <Ionicons name="earth" size={40} color="#10b981" />
                  </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: Platform.OS === 'ios' ? 60 : 50, paddingBottom: 15, backgroundColor: '#fff' },
